...
import { Heart, Shield, Cross, Stethoscope, Activity, Zap, Plus } from 'lucide-react';

const Hero = () => {
  return (
    <section className="relative overflow-hidden min-h-[60vh]">
      {/* Multi-layered Background (all colors hardcoded) */}
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-10">
          <div
            ...
            style={{
              backgroundImage: `
                radial-gradient(circle at 1px 1px, hsl(210 75% 45%) 1px, transparent 0),
                linear-gradient(90deg, transparent 49px, hsl(210 20% 88%) 50px, transparent 51px),
                linear-gradient(transparent 49px, hsl(210 20% 88%) 50px, transparent 51px)
              `,
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed text-[hsl(210_15%_45%)]">
                Your essential guide to emergency first aid procedures. Quick access to
                life-saving techniques when every second counts.
              </p>
            </div>
            ...
            <div className="flex items-center justify-center gap-3 text-sm lg:text-base text-[hsl(210_15%_45%)]">
              <div
                ...
                style={{ backgroundColor: 'hsl(145 65% 45%)' }}
              />
              Available all the time • No registration required
            </div>
          </div>
        </div>
      </div>

      {/* Local animations with explicit colors */}
      <style jsx>{`
